...
const DEV_SERVER_PORT = process.env.OPENSHIFT_NODEJS_PORT || process.env.DEV_SERVER_HOST || 8080;
const DEV_SERVER_HOST = process.env.OPENSHIFT_NODEJS_IP || process.env.DEV_SERVER_HOST || '127.0.0.1';
